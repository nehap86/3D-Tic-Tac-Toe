...
public class runTicTacToe {
	...
	private List<List<positionTicTacToe>> initializeWinningLines()
	{
		...
		//12 mrandommoven diagonal winning lines
		//xz plane-4
		for(int i = 0; i<4; i++)
			{
				List<positionTicTacToe> oneWinCondtion = new ArrayList<positionTicTacToe>();
	...
	public void run()
	{
		...
		{
			System.out.println(ai1.evaluateboard(board));
			if(turn==1)
			{
		...
		//print the Heuristic value. If it is positive infinity player 1 win. If it is negative infinity player 2 win 
		System.out.println(ai1.evaluateboard(board));
